...
struct  CHANNELCONTROL_CALLBACK_TYPE_t466063915 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(CHANNELCONTROL_CALLBACK_TYPE_t466063915, ___value___1)); }
