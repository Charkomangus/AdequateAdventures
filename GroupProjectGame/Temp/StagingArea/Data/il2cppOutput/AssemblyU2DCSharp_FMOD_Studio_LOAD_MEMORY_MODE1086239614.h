...
struct  LOAD_MEMORY_MODE_t1086239614 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(LOAD_MEMORY_MODE_t1086239614, ___value___1)); }
