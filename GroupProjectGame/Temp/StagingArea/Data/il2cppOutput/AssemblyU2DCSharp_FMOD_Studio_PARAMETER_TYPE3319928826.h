...
struct  PARAMETER_TYPE_t3319928826 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(PARAMETER_TYPE_t3319928826, ___value___1)); }
