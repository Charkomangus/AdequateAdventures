...
struct  DSP_PAN_2D_STEREO_MODE_TYPE_t2178638326 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DSP_PAN_2D_STEREO_MODE_TYPE_t2178638326, ___value___1)); }
