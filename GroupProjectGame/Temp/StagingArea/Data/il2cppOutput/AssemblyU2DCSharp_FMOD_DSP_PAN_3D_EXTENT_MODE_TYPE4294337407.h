...
struct  DSP_PAN_3D_EXTENT_MODE_TYPE_t4294337407 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DSP_PAN_3D_EXTENT_MODE_TYPE_t4294337407, ___value___1)); }
