...
struct  DSP_PAN_MODE_TYPE_t336194386 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DSP_PAN_MODE_TYPE_t336194386, ___value___1)); }
